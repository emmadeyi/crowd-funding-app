...
class Transactions extends Component
{
    ...
    {
        return view('livewire.project.transactions', [
            'transactions' => Transaction::whereHas('user')->orderBy('id', 'DESC')->get(),
            'page_transactions' => Transaction::orderBy('id', 'DESC')->paginate(10)
        ]);
    }
