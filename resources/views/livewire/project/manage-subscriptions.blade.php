<div>
    ...
    @endif 
    <p class="uppercase text-base text-gray-700 md:p-2 my-2"> <i class="fa fa-cogs"></i> Manage Subscriptons</p>
                        ...
                        <tr class="block md:table-row border border-gray-300 md:border-0 p-3 rounded mb-3">
                            ...
                            @if(auth()->user()->canany(['Read Project']) || auth()->user()->hasanyrole('Administrator|Developer|Super Admin|'))
                                <td class="flex text-left md:table-cell md:px-3 py-2 md:border">
                                    ...
                                    <a href="{{route('project.subscriptions', Crypt::encrypt($subscription->project->id))}}">
                                        <span class="w-2/3 text-left">{!! \Illuminate\Support\Str::words($subscription->project->title, 4)  !!}</span>
                                    </a>
                                </td>
                            @else
                                <td class="flex text-left md:table-cell md:px-3 py-2 md:border">
