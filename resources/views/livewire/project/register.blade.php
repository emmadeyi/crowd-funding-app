<div>
    ...
    @if (Auth::user()->status == 1)
        <p class="uppercase text-base text-gray-700 md:p-2 my-2"> <i class="fas fa-folder-plus"></i> Register New Project</p>
        <div class="px-4 sm:px-0">
            <form wire:submit.prevent="registerProject">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <x-jet-label for="title" value="{{ __('Title') }}" />
                        <x-jet-input id="title" class="block mt-1 w-full focus:border-gray-300 focus:ring focus:ring-gray-200" type="text" name="title" :value="old('title')" required wire:model.debounce.500ms="title" autofocus />
